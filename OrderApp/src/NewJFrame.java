...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        String LoggedUserName = LoginPage.loggedinUserName; // Get the logged in username
        ResultSet rs = null;
        int GeneratedOrderNumber = 0;  // Get the generated order number after order is placed
        Boolean insertOrderSuccess = true; // Check status whether order placement is successful
        ...
        if (!connectError )
        {
            ...
            if ( !executeError )
            {
                try
                {
                    ...
                    executeUpdateVal = s.executeUpdate(SQLstatement,Statement.RETURN_GENERATED_KEYS);
        ...
        // Insert order entry log into orderentry_login table in userinfo database
             if (insertOrderSuccess)   // if order is succesfully placed
                {
try
        {
        ...
        // If we are connected, then we insert a user entry log inside the 
        // orderentry_audit table in userinfo database
        ...
        if ( !connectError )
        {
            ...
            String OrderDate = sMonth + "/" + sDay + "/" + TheYear ;
            String OrderTime = sHour + ":" + sMinute  + ":" + sSecond;
            
                        
                 s = DBConn.createStatement();    
                 // insert the order entry log into orderlogin_audit table
               SQLstatement = ("insert into orderentry_audit(UserName,OrderNumber,OrderTime,OrderDate)" 
                              + "values ('" + LoggedUserName + "','" +  GeneratedOrderNumber + "','"
                              + OrderTime + "','" + OrderDate + "');");
                ...
                errString =  "\nProblem getting orderentry_audit table:: " + e;
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
         ...
         // jButton6 is responsible for logout feature of this application
        // when logout is clicked, then an log entry is inserted into the
        // orderlogin_audit in userinfo database
        ...
        String LoggedUserName = LoginPage.loggedinUserName; // Get logged in user name
        ResultSet rs = null;
        ...
        // If we are connected, then we insert a order entry log inside the 
        // orderentry_audit table in userinfo database
        ...
        if ( !connectError )
        {
           ...
           // change it to MM/DD/YYYY date format and hh:mm:ss time format
            ...
            String LogTime = sHour + ":" + sMinute  + ":" + sSecond;
                 ...
                 s = DBConn.createStatement(); 
                  // insert the order entry audit into orderlogin_audit table
               SQLstatement = ("insert into orderlogin_audit(UserName,LogTime,LogDate,Activity)" 
                              + "values ('" + LoggedUserName + "','" +  LogTime + "','"
                              + LogDate + "','" + "logout" + "');");
